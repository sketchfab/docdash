...
function buildNav(members) {
  ...
  var sections = {
    ...
    Modules: buildMemberNav(members.modules, "Versions", {}, linkto),
      ...
      if (docdash.menu[menu].isPage) {
        generate(
          ...
          [
            {
              kind: "page",
              longname: docdash.menu[menu].name || menu,
              template: docdash.menu[menu].template,
            },
          ],
          docdash.menu[menu].href
        );
      }
    }
  }
